...
div.hidden
{
   ...
   <div style="height : 445px; width : 90%">
     <div id="page" class="hidden">
	     <div id="login" ng-app="myApp" ng-controller="myCtrl">
	       <div class="row" style="padding-top : 160px;">
	         <div class="col-md-offset-4 col-md-6" ng-if="model.hidden.isShow">
   ...
   <script type="text/javascript">
	   $(document).ready(function() {
	       ...
	       angular.bootstrap(document.getElementById("login"), ['myApp']);
	   });
   </script>
</html>
